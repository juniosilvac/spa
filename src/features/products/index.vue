...
<div>
    <h2>      
      <div class="row">
        ...
        <div class="col-md-6 text-right">          
          ...
          @click="navigation('products.form')">nova</button>
    ...
    <div class="no-products" v-show="!hasProducts">
        ...
        <div class="thumbnail custom-height">      
          <div class="caption">
            ...
            <p class="text-right">
              ...
              <a href="#" @click.prevent="askRemove(product)" class="btn btn-default btn-xs" role="button">
              excluir</a>
            </p>            
          </div>
        </div>
